...
2. AWS Identity and Access Management ( IAM )
   ...
   AWS Identity and Access Management (IAM) ဆိုတာက AWS Services တွေကို ဘယ်လိုအသုံးပြုမလဲ၊ ဘယ်သူက လုပ်ပိုင်ခွင့်ရှိမလဲ ဆိုတာကို စီမံခန့်ခွဲနိုင်ဖို့အတွက် အသုံးပြုတဲ့ Tool တစ်ခုပဲ ဖြစ်ပါတယ်။ ဒီ IAM နဲ့ပတ်သက်ပြီး အရေးကြီးတဲ့ အချက်တွေကို အောက်မှာ ပြောပြပေးပါမယ်။
	...
	4. IAM Groups
	   ...
	   IAM Groups ဆိုတာ က IAM User အများကြီးကို တစ်ခုထဲမှာ အစုအဖွဲ့လုပ်ပြီး ထားသည့် Group တစ်ခုလို့ ဆိုနိုင်ပါတယ်။ Group ထဲက User တွေက အဲဒီ Group ရဲ့ Policies တွေအားလုံး ရရှိမယ်။ ဒါကြောင့် User တစ်ယောက်ချင်းစီ ကို Policy တစ်ခုချင်းစီ မပေးပဲ Group အနေနဲ့ Assign လုပ်တာက လုပ်ငန်းစဉ် ကို ပိုမိုလွယ်ကူစေပါတယ်။
